...
public class DocScanFragment extends androidx.fragment.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_docscan, container, false);
    ...
    public class CreatingPdf extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            path = Environment.getExternalStorageDirectory().getAbsolutePath() +
                    DocScanFragment.this.getString(R.string.pdf_dir);
            ...
            path = path + filename + DocScanFragment.this.getString(R.string.pdf_ext);
